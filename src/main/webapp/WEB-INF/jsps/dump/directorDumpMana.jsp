			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myRouteTask" data-title="待审批任务" data-url="./directorDumpTask.do">
						<a href="javascript:;"> 待审批任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="checkDev" data-title="已审批任务" data-url="./directorAppliedDumpTask.do">
						<a href="javascript:;"> 已审批任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myRouteTaskHistory" data-title="任务历史记录" data-url="./directorDumpTaskRecord.do">
						<a href="javascript:;"> 任务历史记录</a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="checkerDumpDevRecord" data-title="设备报废记录" data-url="./checkerDumpDevRecord.do">
