...
<body>
	<blockquote class="layui-elem-quote news_search">
		<div class="layui-bg-green" style="height: 60px">
			<div style="text-align: center; font-size: 30px; padding-top: 20px">报废任务详情</div>
		</div>
	</blockquote>
	<form class="layui-form" id="taskForm" method="post">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block" style="width: 500px">
				<input type="text" name="tStarterName" id="tStarter" required
					...
					class="layui-input" value="${task.tStarter}">
			</div>
		</div>
		<div class="layui-form-item layui-form-text">
			<label class="layui-form-label" style="width: 100px">报废详情</label>
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				...
				<button class="layui-btn" lay-submit lay-filter="disagree">不同意</button>
			</div>
		</div>
	</form>
	<script type="text/javascript">
		layui.use('form', function() {
			...
			form.on('submit(agree)', function(data) {
				var tView = {};
				tView.reason = $('#tReason').val();
				tView.id = '${task.id}';
				tView.currentState = '${task.TState}';
				tView.act = 'agree';  
				$.ajax({
					url : './checkerDumpMana/taskOperate.do',
					type : 'POST',
					dateType : 'json',
