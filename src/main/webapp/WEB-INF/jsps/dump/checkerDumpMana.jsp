			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="checkerDumpTask" data-title="我的报废任务" data-url="./checkerDumpTask.do">
						<a href="javascript:;"> 我的报废任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="checkerDumpTaskRecord" data-title="报废历史记录" data-url="./checkerDumpTaskRecord.do">
