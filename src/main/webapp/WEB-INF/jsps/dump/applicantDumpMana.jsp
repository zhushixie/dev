			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantDumpTaskForm" data-title="报废单" data-url="./applicantDumpTaskForm.do">
						<a href="javascript:;"> 报废单 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantDumpSaveTask" data-title="已保存的报废任务" data-url="./applicantDumpSaveTask.do">
						<a href="javascript:;"> 已保存的报废任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantDumpTask" data-title="我的报废任务" data-url="./applicantDumpTask.do">
						<a href="javascript:;"> 我的报废任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantDumpTaskRecord" data-title="报废历史记录" data-url="./applicantDumpTaskRecord.do">
						<a href="javascript:;"> 报废任务历史记录 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantDumpDevRecord" data-title="设备报废记录" data-url="./applicantDumpDevRecord.do">
						<a href="javascript:;"> 设备报废记录 </a>
					</li>
				</ul>
			</div>
		</div>
