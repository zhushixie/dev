...
<body>
	...
	<script id="toolbar" type="text/html">
  	<div class="layui-btn-container">
    	...
    	<button class="layui-btn layui-btn-sm" lay-event="getCheckLength">执行报废</button>
    	<button class="layui-btn layui-btn-sm" lay-event="isAll">报废完成</button>
  	</div>
</script>
