...
<body>
	<blockquote class="layui-elem-quote news_search">
		<div class="layui-bg-green" style="height: 60px">
			<div style="text-align: center; font-size: 30px; padding-top: 20px">报废单</div>
		</div>
	</blockquote>
	<form class="layui-form" id="taskForm" method="post">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block" style="width: 500px">
				<input type="text" name="tDevcode" required lay-verify="required"
					placeholder="设备编号" autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label" style="width: 100px">发起人</label>
			<div class="layui-input-block" style="width: 500px">
	...
	$("#tStarter").attr("readonly", "readonly");
		layui.use('form', function() {
			...
			form.on('submit(formDemo)', function(data) {
				$.ajax({
					url : './applicantDumpTaskForm/startTask.do',
					type : 'POST',
					dateType : 'json',
			...
			form.on('submit(saveDemo)', function(data) {
				$.ajax({
					url : './applicantDumpTaskForm/saveTask.do',
					type : 'POST',
					dateType : 'json',
					contentType : 'application/x-www-form-urlencoded',
					data : $("#taskForm").serializeArray(),
