...
layui.use('table', function(){
  ...
  table.render({
    elem: '#task'
    ,url:'./applicantDumpTaskRecord/list.do'
    ...
    ,cols: [[
             {field:'id', width:100, title: '设备编号', sort: true}
             ,{field:'tname', width:300, title: '设备所属部门',sort: true}
             ,{field:'tdumptime', width:100, title: '设备位置', sort: true}
