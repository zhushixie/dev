...
<a style="height:25px;margin-top:5px;margin-bottom:5px;line-height:20px" class="layui-btn layui-btn-danger" lay-event="del">删除</a>
</script>
	<script>
layui.use('table', function(){
  ...
  table.on('tool(task)', function(obj){
	    ...
	    if(obj.event === 'edit'){
	      ...
	      layer.confirm('真的删除这个任务么', function(index){
				$.ajax({
					url : './keeperWareInTask/deleteTask.do?id='+data.id,
					type : 'POST',
