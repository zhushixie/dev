...
<body>
	<blockquote class="layui-elem-quote news_search">
		<div class="layui-bg-green" style="height: 60px">
			<div style="text-align: center; font-size: 30px; padding-top: 20px">损耗任务</div>
		</div>
	</blockquote>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block" style="width: 500px">
				<input type="text" name="tStarterName" id="tStarter" required
					lay-verify="required" placeholder="申请人" autocomplete="off"
					class="layui-input">
			</div>
		</div>
		<div class="layui-form-item layui-form-text">
			<label class="layui-form-label" style="width: 100px">损耗详情</label>
