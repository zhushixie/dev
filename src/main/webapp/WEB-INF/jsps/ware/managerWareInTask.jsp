...
<body>
	...
	<div style="text-align:center;font-size:30px;padding-top:20px;float:left">我审批的采购任务</div>
	    ...
	    if(obj.event === 'detail'){  
		    layui.use('layer', function(){
		    	  ...
		    	  layer.open({
		    		  ...
		    		  maxmin: true,
		    		  resize:true,
		    		  content: './managerWareInTaskDetail.do?id='+data.id
		    		});	    	  
		    	});
	    }
});
