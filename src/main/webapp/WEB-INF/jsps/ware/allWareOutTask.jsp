...
<body>
	<blockquote class="layui-elem-quote news_search">
		<div class="layui-bg-green" style="height: 60px">
			<div style="text-align: center; font-size: 30px; padding-top: 20px">调用任务</div>
		</div>
	</blockquote>
	<form class="layui-form" id="taskForm" method="post">
		...
		<div class="layui-form-item layui-form-text">
			<label class="layui-form-label" style="width: 100px">调用详情</label>
	...
	$("#tStarter").attr("readonly", "readonly");
		layui.use('form', function() {
			...
			form.on('submit(formDemo)', function(data) {
				$.ajax({
					url : './allWareOutTask/startTask.do',
					type : 'POST',
					dateType : 'json',
			...
			form.on('submit(saveDemo)', function(data) {
				$.ajax({
					url : './allWareOutTask/saveTask.do',
					type : 'POST',
					dateType : 'json',
					contentType : 'application/x-www-form-urlencoded',
					data : $("#taskForm").serializeArray(),
