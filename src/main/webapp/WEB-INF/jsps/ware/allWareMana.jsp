		...
		<div class="layui-side layui-bg-black">
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
                        ...
                        <dl class="layui-nav-child">
                            <dd class="layui-navi" data-id="allWareOutTask" data-title="库存盘点记录" data-type="tabAdd" data-url="./allWareOutTask.do">
                                <a href="javascript:;">
                                    配件调用单
                                </a>
                            </dd>
                           <dd class="layui-navi" data-id="allWareOutSaveTask" data-title="已提交的损耗任务" data-type="tabAdd" data-url="./allWareOutSaveTask.do">
                                <a href="javascript:;">
                                    我保存的任务
                                </a>
                            </dd>
                            <dd class="layui-navi" data-id="allWareOutStartTask" data-title="已提交的损耗任务" data-type="tabAdd" data-url="./allWareOutStartTask.do">
                                <a href="javascript:;">
                                    我发起的任务
                                </a>
                            </dd>
                            <dd class="layui-navi" data-id="allWareOutTaskRecords" data-title="任务历史记录" data-type="tabAdd" data-url="./allWareOutTaskRecords.do">
                                <a href="javascript:;">
                                   我的任务历史记录
                                </a>
                            </dd>
