...
<body>
	...
	<div style="text-align:center;font-size:30px;padding-top:20px;float:left">审批任务记录</div>
  ...
  <a style="height:25px;margin-top:5px;margin-bottom:5px;line-height:20px" class="layui-btn layui-btn-xs" lay-event="finish">完成</a>
</script>
	<script>
layui.use('table', function(){
  ...
  table.render({
    elem: '#task'
    ,url:'./directorWareInTaskRecords/list'
  ...
  table.on('tool(task)', function(obj){
	    ...
	    if(obj.event === 'finish'){
				$.ajax({
					url : './routeMana/operaTaskState.do?tType=finish&&id='+data.id,
					type : 'POST',
