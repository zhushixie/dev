...
<script>
    ...
    layui.config({
        ...
        ptable=treeGrid.render({
            id:tableId
            ,elem: '#'+tableId
            ,url:'./authMana/findSelectedAuths.do?id=${requestScope.id}'
            ,cellMinWidth: 100
            ,idField:'id'//必須字段
            ,treeId:'id'//树形id字段名称
            ...
            ,onCheck:function (obj,checked,isAll) {//复选事件
                ...
                var roleAuth = new Object();
                roleAuth.roleid = ${requestScope.id};
                roleAuth.authid= obj.id;
                roleAuth.id = 0; 
                console.log(obj,checked,isAll);
                
            	if(checked){
    				$.ajax({
    					url : './authMana/addRoleAuth.do',
    					type : 'POST',
    					dateType : 'json',
    				...
    				$.ajax({
    					url : './authMana/deleteRoleAuth.do',
    					type : 'POST',
    					dateType : 'json',
    					contentType : 'application/x-www-form-urlencoded',
    					data : roleAuth,
