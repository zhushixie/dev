...
<body class="layui-layout-body">
	<div class="dialog" id="dialog">
		...
		<div class="dialog_content" style="height:220px">
			<form action="./flowDef/create.do" method="get" style="margin-left:40px">
				<div style="height: 60%; top: 20%; width: 80%; margin: 0 auto">
					<div style="margin: 20px auto">
						名称 :<input type="text" id="name" name="name" placeholder="name"></input>
					</div>
					<div style="margin: 20px auto">
						I&nbsp&nbsp&nbsp&nbspD:<input type="text" id="key" name="key"
				...
				<div style="float:left;width:35%;margin-left:20px;">
					<input style="width:80%;" class="button cl" type="submit" value="提交" id="submit">
				</div>
				<div style="float:right; width:35%;margin-right:20px">
					<input style="width:80%" class="button cl" type="button" value="取消" id="btnCancel">
				</div>
			</form>
		</div>
	</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item"><a href="javascript:;"> 入库管理 </a>
						<dl class="layui-nav-child">
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDefine"
								data-title="流程定义" data-url="./listModel.do">
								<a href="javascript:;"> 采购单填写 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 已保存的采购任务 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 我的采购任务 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 我的采购记录 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 我的入库记录 </a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item"><a href="javascript:;"> 库存管理 </a>
						<dl class="layui-nav-child">
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDefine"
								data-title="流程定义" data-url="./listModel.do">
								<a href="javascript:;"> 损耗单填写 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 已保存的损耗单 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 我的损耗任务 </a>
							</dd>
														<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 我的损耗任务记录 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 库存盘点记录 </a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item"><a href="javascript:;"> 出库管理 </a>
						<dl class="layui-nav-child">
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDefine"
								data-title="流程定义" data-url="./listModel.do">
								<a href="javascript:;"> 出库单填写 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 已保存的出库任务 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 我的出库任务 </a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 我的出库任务记录</a>
							</dd>
							<dd class="layui-navi" data-type="tabAdd" data-id="flowDeploy"
								data-title="流程部署" data-url="./deptMana.do">
								<a href="javascript:;"> 我的出库记录 </a>
							</dd>
						</dl>
					</li>
