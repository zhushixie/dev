	...
	<form class="layui-form" id="taskForm" method="post">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-block" style="width: 400px">
				<input type="text" name="tCode" id="tCode" required
					lay-verify="required" placeholder="请输入编码" autocomplete="off"
					class="layui-input">
			</div>
		</div>
				<div class="layui-inline">
			...
			<div class="layui-form-item">
				<label class="layui-form-label" style="width: 100px">运行状况</label>
				<div class="layui-input-block" style="width: 500px">
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea name="tContent" id="tContent" placeholder="请输入具体故障信息" class="layui-textarea"
	...
	$("option[value='1']").attr("selected","");
		layui.use('form', function() {
			...
			form.on('submit(formDemo)', function(data) {
				$.ajax({
					url : './routeMana/mySubmitCheckDev.do',
					type : 'POST',
					dateType : 'json',
