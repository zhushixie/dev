			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myFixReport" data-title="故障单" data-url="./myFixReport.do">
						<a href="javascript:;"> 故障单 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myExecuteTask" data-title="已保存的故障单" data-url="./myFixSaveTask.do">
						<a href="javascript:;"> 已保存的故障单 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="checkDev" data-title="已发起的故障单" data-url="./myFixStartTask.do">
						<a href="javascript:;"> 已发起的故障单</a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myDevRecord" data-title="我的验收任务" data-url="./myReceiveReport.do">
						<a href="javascript:;"> 我的验收任务 </a>
					</li>
										<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myDevRecord" data-title="我的任务记录" data-url="./myReceiveReport.do">
						<a href="javascript:;"> 我的任务记录 </a>
					</li>
				</ul>
			</div>
		</div>
