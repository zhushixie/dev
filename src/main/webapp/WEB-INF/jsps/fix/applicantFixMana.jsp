			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantFixTask" data-title="申请维修" data-url="./applicantFixTask.do">
						<a href="javascript:;"> 申请维修 </a>
					</li>
										<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantFixSaveTask" data-title="已保存任务" data-url="./applicantFixSaveTask.do">
						<a href="javascript:;"> 已保存任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantFixStartTask" data-title="我的任务" data-url="./applicantFixStartTask.do">
						<a href="javascript:;"> 我的任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="applicantFixTaskRecords" data-title="任务记录" data-url="./applicantFixTaskRecords.do">
