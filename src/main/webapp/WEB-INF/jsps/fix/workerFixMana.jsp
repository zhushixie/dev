			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="workerFixFaultSaveTask" data-title="已保存的故障单" data-url="./workerFixTasks.do">
						<a href="javascript:;"> 我的维修任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="workerFixFaultStartTask" data-title="已发起的故障单" data-url="./workerFixFaultStartTask.do">
						<a href="javascript:;"> 零配件调用单</a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="workerFixFaultStartTask" data-title="已发起的故障单" data-url="./workerFixFaultStartTask.do">
						<a href="javascript:;"> 已保存零配件任务</a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="workerFixReceiveReportTask" data-title="我的验收任务" data-url="./workerFixReceiveReportTask.do">
						<a href="javascript:;"> 我的零配件任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="workerFixReceiveReportTask" data-title="我的验收任务" data-url="./workerFixReceiveReportTask.do">
						<a href="javascript:;"> 零配件调用记录 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="workerFixTaskRecords" data-title="我的任务记录" data-url="./workerFixTaskRecords.do">
						<a href="javascript:;"> 我的维修任务记录 </a>
					</li>
				</ul>
			</div>
		</div>
