			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="directorFixTask" data-title="所有故障任务" data-url="./directorFixTask.do">
						<a href="javascript:;"> 所有故障任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="directorFixAssignTask" data-title="已委派的任务" data-url="./directorFixAssignTask.do">
						<a href="javascript:;"> 已委派的任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="directorFixTaskRecord" data-title="故障任务记录" data-url="./directorFixTaskRecord.do">
						<a href="javascript:;"> 故障任务记录 </a>
					</li>
				</ul>
			</div>
		</div>
