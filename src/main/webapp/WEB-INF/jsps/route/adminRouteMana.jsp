			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="userMana" data-title="发布任务" data-url="./releaseTask.do">
						<a href="javascript:;"> 发布任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="acceptedTask" data-title="已保存任务" data-url="./adminRouteSaveTask.do">
						<a href="javascript:;"> 已保存任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myRouteRecord" data-title="已发布任务" data-url="./adminRouteStartTask.do">
						<a href="javascript:;"> 已发布任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="adminRouteTaskHistory" data-title="任务历史" data-url="./adminRouteTaskHistory.do">
						<a href="javascript:;"> 任务历史 </a>
					</li>
										<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myRouteRecord" data-title="员工巡检记录" data-url="./myRouteRecord.do">
						<a href="javascript:;"> 员工巡检记录 </a>
					</li>
				</ul>
			</div>
		</div>
