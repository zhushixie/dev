			...
			<div class="layui-side-scroll">
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myRouteTask" data-title="我的任务" data-url="./myRouteTask.do">
						<a href="javascript:;"> 我的任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myExecuteTask" data-title="正在执行的任务" data-url="./myExecuteTask.do">
						<a href="javascript:;"> 正在执行的任务 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="checkDev" data-title="巡检登记" data-url="./myCheckDev.do">
						<a href="javascript:;"> 巡检登记 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myDevRecord" data-title="我的巡检记录" data-url="./myDevRecord.do">
						<a href="javascript:;"> 巡检记录 </a>
					</li>
					<li class="layui-nav-item layui-navi" data-type="tabAdd"
						data-id="myRouteTaskHistory" data-title="历史记录" data-url="./myRouteTaskHistory.do">
