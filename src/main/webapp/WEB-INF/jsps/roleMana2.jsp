		...
		$.each(
						...
						function(index, obj) {
							...
							info += '<tr style="height:40px"><td style="text-align:center"><input type="checkbox" name="id" value='+obj.id+' lay-skin="primary" ></td>'
									...
									+ obj.id+')" data-params=\'{"url": "./userMana/delete","confirm":true,"data":"id='+obj.id+'}\'><i class="layui-icon">&#xe640;</i> 删除</a>'
									+ '<a id="modifyAuth" class="layui-btn layui-btn-mini modal-iframe" style="height:25px;margin-top:5px;margin-bottom:5px;line-height:20px" onclick="modifyAuth('+obj.id+')" data-params=\'{"content": "/menu/addItem?id={{'+obj.id+'}}", "title": "编辑权限","full":false,"area":"600px,480px"}\'><i class="iconfont icon-edit"></i> 修改权限</a>'
									+ '</td></tr>';
						});
		$("#tbody").html(info);
		tableTest();
