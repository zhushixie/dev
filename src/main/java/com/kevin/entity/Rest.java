...
public class Rest {
	...
	public String toString() {
		return "{'status':'" + status + "', 'render':'" + render + "', 'msg':'" + msg + "', 'data':'" + data + "', 'pages':'" + pages
	...
	public static Rest errorRet(int i, String string) {
		Rest rest = new Rest();
		rest.status = i;
		rest.msg = string;
		return rest;
	...
	public static Rest successRet(Object object) {
		Rest rest = new Rest();
		rest.status = 0;
		rest.msg = null;
		return rest;
